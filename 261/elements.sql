...
alter table elements add column id integer;
update elements set id = atomic_number;
alter table elements add primary key (id);

update elements set category = 'nonmetals' where id in (1,6,7,8,15,16,34);
update elements set category = 'alkali metals' where id in (3,11,19,37,55,87);
update elements set category = 'alkaline metals' where id in (4,12,20,38,56,88);

update elements set category = 'other metals' where id in (13,31,49,81,50,82,83);
update elements set category = 'metalloids' where id in (5,14,32,33,51,52,84);
update elements set category = 'halogens' where id in (9,17,35,53,85);
update elements set category = 'noble gases' where id in (2,10,18,36,54,86);
update elements set category = 'lanthanides' where id between 57 and 71;
update elements set category = 'actinides' where id between 89 and 103;
update elements set category = 'transition elements' where category is null;
alter table elements alter column category set not null;

update elements set melting_point = melting_point - 273.15;
update elements set boiling_point = boiling_point - 273.15;
