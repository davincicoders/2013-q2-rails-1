...
insert into properties
  (address, city, state, price, num_bedrooms, num_stories, num_square_feet,
    image_url,
    created_at, updated_at)
  values ('35 Oak Ln', 'Louisville', 'CO', '$1,000,000', 3, 2, '5,000',
...
insert into properties
  (address, city, state, price, num_bedrooms, num_stories, num_square_feet,
    image_url,
    created_at, updated_at)
  values ('254 Marigold Ct', 'Lafayette', 'CO', '$125,000', 3, 1, '7,000',
    'http://farm8.staticflickr.com/7047/6973026131_8e733ee374.jpg',
    now(), now());

drop table if exists property_admins;
...
insert into property_admins (username, password)
  values ('Sue', 'Sue');
